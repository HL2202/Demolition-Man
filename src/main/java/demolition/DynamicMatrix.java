...
public class DynamicMatrix {
    ...
    public DynamicMatrix(String path) {
    ...
    public void resetLevel1(ArrayList<String> level1, String path) {
    ...
    public void resetLevel2(ArrayList<String> level2, String path) {
